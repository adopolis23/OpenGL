...
ifeq ($(config),debug)
  RESCOMP = windres
  TARGETDIR = bin/Debug
  TARGET = $(TARGETDIR)/ParticalSimulation
  OBJDIR = bin-int/Debug
  DEFINES += -DDEBUG
  INCLUDES += -Isrc -Isrc/shaders -Ilibs/glad/include -I/usr/include
  FORCE_INCLUDE +=
...
$(TARGET): $(GCH) ${CUSTOMFILES} $(OBJECTS) $(LDDEPS) $(RESOURCES) | $(TARGETDIR)
	@echo Linking ParticalSimulation
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning ParticalSimulation
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
